...
const daysData: DayData[] = [
  {
    ...
    items: [
      ...
      { type: 'transport', mode: '包车', duration: '30分钟', destination: '涯月邑' },
      {
        ...
        title: '涯月午餐',
        description: '涯月附近海边餐厅，品尝济州当地美食',
        typeLabel: '午餐',
        tags: [{ type: 'dining', label: '用餐' }],
        learnMoreContent: '涯月邑沿海有很多特色餐厅，可以让司机推荐当地人气店。济州代表美食：黑猪肉、海鲜锅、鲍鱼粥等都值得一试。预留1.5小时用餐时间。',
        bgTint: '#FFF5F5',
      },
      ...
      { type: 'transport', mode: '包车', duration: '15分钟', destination: '晚餐地点' },
      {
        type: 'activity', dotColor: colors.dotRestaurant, time: '14:35',
        title: '晚餐',
        description: '涯月海边餐厅，包车直达，避免走回头路',
        typeLabel: '晚餐',
        tags: [{ type: 'dining', label: '用餐' }],
        learnMoreContent: '可选择涯月海边的韩式餐厅，推荐济州黑猪肉烤肉或海鲜火锅。预留1.5小时用餐，让司机推荐当地口碑餐厅。',
        bgTint: '#FFF5F5',
      },
  ...
  },
  {
    ...
    items: [
      ...
      { type: 'transport', mode: '包车', duration: '10分钟', destination: '午餐地点' },
      {
        type: 'activity', dotColor: colors.dotRestaurant, time: '10:20',
        title: '午餐',
        description: '月汀里附近或城山日出峰途中餐厅',
        typeLabel: '午餐',
        tags: [{ type: 'dining', label: '用餐' }],
        learnMoreContent: '可在月汀里附近或前往城山日出峰途中的餐厅用餐。推荐济州海鲜料理或当地特色小店，预留1.5小时用餐。',
        bgTint: '#FFF5F5',
      },
      ...
      { type: 'transport', mode: '包车', duration: '30分钟', destination: '晚餐地点' },
      {
        type: 'activity', dotColor: colors.dotRestaurant, time: '17:30',
        title: '晚餐',
        description: '根据实际行程选择，包车直达晚餐地点',
        typeLabel: '晚餐',
        tags: [{ type: 'dining', label: '用餐' }],
        learnMoreContent: '可根据当天实际路线选择东部或回市区方向的餐厅。推荐济州黑猪肉、海鲜料理等当地特色。预留1.5小时用餐。',
        bgTint: '#FFF5F5',
      },
  ...
  },
  {
    ...
    items: [
      ...
      { type: 'transport', mode: '包车', duration: '10分钟', destination: '午餐地点' },
      {
        ...
        title: '午餐',
        description: '保健路附近韩式料理，为下午购物节省时间',
        typeLabel: '午餐',
        tags: [{ type: 'dining', label: '用餐' }],
        learnMoreContent: '可选择保健路周边的韩式料理店，让司机推荐口碑餐厅。吃饱后开启下午购物行程。预留1.5小时用餐。',
        bgTint: '#FFF5F5',
      },
      ...
      { type: 'transport', mode: '包车', duration: '5分钟', destination: '晚餐地点' },
      {
        type: 'activity', dotColor: colors.dotRestaurant, time: '17:30',
        title: '晚餐',
        description: '东门市场周边或市中心餐厅，感受济州市井气息',
        typeLabel: '晚餐',
        tags: [{ type: 'dining', label: '用餐' }],
        learnMoreContent: '可品尝市场小吃或当地特色正餐。东门市场周边有很多人气小店，可让司机推荐。预留1.5小时用餐。',
        bgTint: '#FFF5F5',
      },
