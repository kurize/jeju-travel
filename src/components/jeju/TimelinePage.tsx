...
const daysData: DayData[] = [
  {
    ...
    mapStops: [
      ...
      { name: '협재더꽃돈', coord: [33.3940, 126.2400], emoji: '🥩', type: 'restaurant' },
    ],
    items: [
      {
      ...
      { type: 'transport', mode: '包车', duration: '5分钟', destination: '협재더꽃돈' },
      {
        type: 'activity', dotColor: colors.dotRestaurant, time: '14:35',
        title: '협재더꽃돈 黑猪肉', koreanTitle: '협재더꽃돈',
        description: '挟才黑猪肉烤肉 | 评分4.5 | 店员帮烤 | 厚切熟成肉',
        typeLabel: '晚餐',
        tags: [{ type: 'dining', label: '用餐' }],
        learnMoreContent: '협재더꽃돈是挟才海水浴场附近人气黑猪肉烤肉店，评分4.5。招牌：흑돼지1근(600g) 69,000韩元，오겹살200g 23,000韩元。店员帮烤，酱料多样，泡菜汤可无限续。地址：한림읍 한림로 366。营业12:00-23:00（周一休息）。',
        learnMoreImage: '/places/kkotdon.jpg',
        bgTint: '#FFF5F5',
      },
  ...
  },
  {
    ...
    mapStops: [
      ...
      { name: '함덕그때그집', coord: [33.5430, 126.6700], emoji: '🥩', type: 'restaurant' },
    ],
    items: [
      ...
      { type: 'transport', mode: '包车', duration: '15分钟', destination: '함덕그때그집' },
      {
        type: 'activity', dotColor: colors.dotRestaurant, time: '17:30',
        title: '함덕그때그집 黑猪肉', koreanTitle: '함덕그때그집',
        description: '咸德熟成黑猪肉 | 评分4.4 | 泡菜汤无限续 | 厚切肉质佳',
        typeLabel: '晚餐',
        tags: [{ type: 'dining', label: '用餐' }],
        learnMoreContent: '함덕그때그집位于咸德海水浴场旁，以熟成黑猪肉烤肉出名，评分4.4（口味4.8）。招牌：숙성흑돼지2人套餐400g 53,000韩元、김치찌개（午餐限定）10,000韩元。厚切肉质好，基础小菜无限续。地址：조천읍 조함해안로 486。营业11:00-22:00（周三休息）。',
        learnMoreImage: '/places/hamdeok-bbq.jpg',
        bgTint: '#FFF5F5',
      },
